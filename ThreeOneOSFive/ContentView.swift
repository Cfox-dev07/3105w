...
private struct DashboardView: View {
    ...
    @State private var showDylibInjector = false
    ...
    var body: some View {
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button { showDylibInjector = true } label: {
                        Image(systemName: "bolt.horizontal.circle")
                    }
                    .accessibilityLabel("Dylib Injector")
                }
                ToolbarItem(placement: .navigationBarTrailing) {
            ...
            .sheet(isPresented: $showDylibInjector) { DylibInjectionView() }
        }
    }
